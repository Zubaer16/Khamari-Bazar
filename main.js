...
const updatCartList = (product_name, product_price, product_quantity, product_img) => {
...
cart.forEach((item)=>{
    updatCartList(item.product_name,item.product_price,item.product_quantity,item.product_img);
})
